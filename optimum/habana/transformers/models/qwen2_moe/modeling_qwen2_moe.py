...
class GaudiQwen2MoeSparseMoeBlock(torch.nn.Module):
    def __init__(self, config):
        ...
        self.experts = torch.nn.ModuleList(
            [GaudiQwen2MoeMLP(config, intermediate_size=config.moe_intermediate_size) for _ in range(self.num_experts)]
        )
